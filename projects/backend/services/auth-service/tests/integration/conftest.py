    ...
    try:
        ...
        if count == 0:
            await conn.execute("""
                ...
                ('configs.view', 'system', 'configs', 'View configs'),
                ('configs.create', 'system', 'configs', 'Create configs'),
                ('configs.update', 'system', 'configs', 'Update configs'),
                ('configs.delete', 'system', 'configs', 'Delete configs'),
                ('configs.activate', 'system', 'configs', 'Activate configs'),
                ('configs.rollback', 'system', 'configs', 'Rollback configs'),
                ('configs.schemas.manage', 'system', 'configs', 'Manage config schemas'),
                ('configs.sensitive.read', 'system', 'configs', 'Read sensitive config values'),
        ...
        if role_count == 0:
            await conn.execute("""
                ...
                ('00000000-0000-0000-0000-000000000005', 'config_viewer', 'system', NULL, true, 'Config viewer'),
                ('00000000-0000-0000-0000-000000000006', 'config_editor', 'system', NULL, true, 'Config editor'),
                ('00000000-0000-0000-0000-000000000007', 'config_operator', 'system', NULL, true, 'Config operator'),
                ('00000000-0000-0000-0000-000000000008', 'config_admin', 'system', NULL, true, 'Config admin'),
