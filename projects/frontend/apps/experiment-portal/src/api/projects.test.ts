...
describe('projectsApi', () => {
    ...
    describe('list', () => {
        it('calls GET /api/v1/projects with params and unwraps {items,total}', async () => {
    ...
    describe('get', () => {
        it('calls GET /api/v1/projects/{id}', async () => {
            ...
            expect(mockAxiosInstance.get).toHaveBeenCalledWith('/api/v1/projects/p1')
            expect(result).toEqual(project)
        })
    })

    describe('create', () => {
        it('calls POST /api/v1/projects with payload', async () => {
            ...
            expect(mockAxiosInstance.post).toHaveBeenCalledWith('/api/v1/projects', payload)
            expect(result).toEqual(created)
        })
    })

    describe('update', () => {
        it('calls PUT /api/v1/projects/{id} with payload', async () => {
            const upd = { name: 'New' }
            ...
            expect(mockAxiosInstance.put).toHaveBeenCalledWith('/api/v1/projects/p1', upd)
            expect(result).toEqual(project)
        })
    })
    ...
    describe('delete', () => {
        it('calls DELETE /api/v1/projects/{id}', async () => {
            ...
            expect(mockAxiosInstance.delete).toHaveBeenCalledWith('/api/v1/projects/p1')
        })
    })
    ...
    describe('listMembers', () => {
        it('calls GET /api/v1/projects/{id}/members', async () => {
            ...
            expect(mockAxiosInstance.get).toHaveBeenCalledWith('/api/v1/projects/p1/members')
            expect(result).toEqual(members)
        })
    })

    describe('addMember', () => {
        it('calls POST /api/v1/projects/{id}/members with payload', async () => {
    ...
    describe('removeMember', () => {
        it('calls DELETE /api/v1/projects/{pid}/members/{uid}', async () => {
            mockAxiosInstance.delete.mockResolvedValueOnce({ data: {} })

            await projectsApi.removeMember('p1', 'u1')

            expect(mockAxiosInstance.delete).toHaveBeenCalledWith('/api/v1/projects/p1/members/u1')
        })
    })

    describe('updateMemberRole', () => {
        it('calls PUT /api/v1/projects/{pid}/members/{uid}/role', async () => {
            ...
            expect(mockAxiosInstance.put).toHaveBeenCalledWith(
                '/api/v1/projects/p1/members/u1/role',
                payload
            )
            expect(result).toEqual(member)
        })
